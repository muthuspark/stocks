		...
		<div class="col-md-3">
			<div class="row" ng-controller="mycontroller">
				<p>
				  ...
				  <input type="number" value="0" id="lower" min="0" placeholder="Min value"/>
				  <input type="number" value="0" id="higher" min=0 placeholder="Max value"/>
...
function getHistoryOfSymbol(sym){
	...
	$.ajax({
		  ...
		  .done(function( data ) {
			  resdata = data;
			  plotchart(options, "container",data.history,"Since Beginning");
			  getCurrentPrice(sym);
			  $("#spinner").hide();
		 }).fail(function(){
			 $("#spinner").hide(); 
...
$(function () {
    ...
    function recalculate(){
		$.ajax({
    		  url: "Utility?operation=pricefilter&min="+$("#lower").val()+"&max="+$("#higher").val(),
    		  contentType: "text/html" 
    		  })
    		  .done(function( data ) {
