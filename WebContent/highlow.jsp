...
<body>
<%
List<Stock> bulls = Datawarehouse.getStocksWithMaxLessthanCurrent();
List<Stock> bears = Datawarehouse.getStocksWithMaxGreaterthanCurrent();
%>
...
<div class="container-fluid">
	<div class="row text-center">
		...
		<h1>Bull and Bear</h1>
		<p>Comparing the high and low performing stocks</p>
